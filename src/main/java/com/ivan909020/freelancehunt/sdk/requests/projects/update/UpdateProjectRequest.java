...
import com.ivan909020.freelancehunt.sdk.requests.PatchApiRequest;
import com.ivan909020.freelancehunt.sdk.responses.projects.update.UpdateProjectResponse;
...
public class UpdateProjectRequest extends PatchApiRequest<UpdateProjectResponse> {
    ...
    @Override
    public UpdateProjectResponse deserializeResponse(HttpResponse response) throws IOException {
