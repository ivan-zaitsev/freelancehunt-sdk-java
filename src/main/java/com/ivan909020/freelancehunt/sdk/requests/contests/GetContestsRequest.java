...
import com.ivan909020.freelancehunt.sdk.responses.contests.GetContestsResponse;
...
public class GetContestsRequest extends GetApiRequest<GetContestsResponse> {
    ...
    @Override
    public GetContestsResponse deserializeResponse(HttpResponse response) throws IOException {
